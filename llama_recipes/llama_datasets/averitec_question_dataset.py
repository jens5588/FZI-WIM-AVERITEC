...
def get_preprocessed_averitec_question(dataset_config, tokenizer, split):
    dataset = load_dataset("json",
                           data_files={
                               'train': './data/instruction_question_generation_sub_included_train_combined.json',
                               'test': './data/instruction_question_generation_sub_included_test.json'},
...
if __name__ == '__main__':
    ...
    get_preprocessed_averitec_question(None, tokenizer, 'train')
    get_preprocessed_averitec_question(None, tokenizer, 'test')
