...
tokenizer = BloomTokenizerFast.from_pretrained("/hkfs/work/workspace_haic/scratch/vl8701-llm2/bloom-7b1")
model = BloomForCausalLM.from_pretrained(
    "/hkfs/work/workspace_haic/scratch/vl8701-llm2/bloom-7b1",
    torch_dtype=torch.bfloat16,
).to(device)

for example in tqdm.tqdm(examples[:20]):
...
with open('./data/dev.generated_questions.json', 'w') as file:
